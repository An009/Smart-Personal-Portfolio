...
const LanguageCard: React.FC<LanguageCardProps> = ({ language, index }) => (
  <div className="group flex items-center justify-between p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-[#252B3B] transition-all">
    <div className="flex items-center gap-3">
      <div className="w-10 h-10 flex items-center text-gray-500 dark:text-gray-400 justify-center text-2xl rounded-lg bg-gray-100 dark:bg-[#252B3B] group-hover:bg-white dark:group-hover:bg-[#2A3040] shadow-sm">
        {language.flag}
      </div>
