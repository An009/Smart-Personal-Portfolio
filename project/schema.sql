...
CREATE OR REPLACE FUNCTION "public"."insert_embedding"("content" "text", "embedding" "public"."vector") RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    SET search_path TO public;  -- Set the search path explicitly
...
ALTER FUNCTION "public"."insert_embedding"("content" "text", "embedding" "public"."vector") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."match_embeddings"("query_embedding" "public"."vector", "match_threshold" double precision, "match_count" integer) RETURNS TABLE("id" integer, "content" "text", "similarity" double precision)
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    SET search_path TO public;  -- Set the search path explicitly
...
CREATE OR REPLACE FUNCTION "public"."search_embeddings"("query_embedding" "public"."vector", "similarity_threshold" double precision, "limit_count" integer) RETURNS TABLE("id" "uuid", "content" "text", "similarity" double precision)
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    SET search_path TO public;  -- Set the search path explicitly
...
ALTER FUNCTION "public"."search_embeddings"("query_embedding" "public"."vector", "similarity_threshold" double precision, "limit_count" integer) OWNER TO "postgres";
...
CREATE POLICY "Enable insert for authenticated users only" ON "public"."embeddings" FOR INSERT TO "authenticated" WITH CHECK (true);
...
GRANT ALL ON FUNCTION "public"."insert_embedding"("content" "text", "embedding" "public"."vector") TO "anon";
GRANT ALL ON FUNCTION "public"."insert_embedding"("content" "text", "embedding" "public"."vector") TO "authenticated";
GRANT ALL ON FUNCTION "public"."insert_embedding"("content" "text", "embedding" "public"."vector") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."search_embeddings"("query_embedding" "public"."vector", "similarity_threshold" double precision, "limit_count" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."search_embeddings"("query_embedding" "public"."vector", "similarity_threshold" double precision, "limit_count" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."search_embeddings"("query_embedding" "public"."vector", "similarity_threshold" double precision, "limit_count" integer) TO "service_role";
